        ...
        <div class="col-12">
            ...
            <div class="card card-success">
                ...
                <form role="form" method="post" action="{{ route("product_edit",["product"=>$product->id]) }}" enctype="multipart/form-data">
                    @method("PUT") <!-- Lam API: Neu trong route de method la Route::put -->
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="customFile">
                                        Thumbnail
                                        <a href="$product->thumbnail" target="_blank"><img src="{{url("$product->thumbnail")}}" width="40"></a>
                                    </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="quantity" value="{{$product->quantity}}" class="form-control" placeholder="Enter quantity ..." required>
                                    @error("quantity")
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="mb-3">
                                <textarea class="textarea" name="description" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$product->description}}</textarea>
                            </div>
...
@section("after_js")
    ...
    <script>
        ...
        CKEDITOR.ClassicEditor.edit(document.getElementById("editor"), {

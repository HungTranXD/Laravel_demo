...
@section("list-product-menu-status", "")
@section("create-product-menu-status", "active")
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="price" value="{{old("price")}}" class="form-control" placeholder="Enter price ..." required>
